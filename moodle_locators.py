...
admin_username = 'sabinashaikh'
admin_password = 'Inaayakhan786$'
...
list_of_insterests = [fake.job(), fake.job(), fake.job(), fake.job()]
...
lst_opt = ['Web page', 'ICQ number', 'Skype ID', 'AIM ID', 'Yahoo ID', 'MSN ID', 'ID number', 'Institution', 'Department', 'Phone', 'Mobile phone', 'Address' ]
