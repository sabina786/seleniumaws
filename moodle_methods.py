...
def log_in(username, password):
    print(f'--------------***-----------------------------')
    if driver.current_url == locators.moodle_url: # check we are in the home page
        driver.find_element(By.LINK_TEXT, 'Log in').click()
        if driver.current_url == locators.moodle_login_page_url and driver.title == locators.moodle_login_page_title: # check we are in login page
...
def search_user():
    ...
    if locators.moodle_users_main_page_url in driver.current_url and driver.title == locators.moodle_users_main_page_title:
        ...
        print(f'----Browser list of new user is display----- ')
